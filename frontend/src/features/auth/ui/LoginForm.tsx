        ...
        <div className="text-center mb-10">
          <div className="flex items-center justify-center space-x-4 mb-2">
            ...
            <h1 className="text-4xl font-extrabold">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#DC0A2D] to-[#FF4565]">
                Pokédex
              </span>
            </h1>
          </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative rounded-md">
                  <input
                    ...
                    } rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-200 placeholder-gray-400 text-gray-900`}
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full flex justify-center py-3 px-4 text-sm font-medium rounded-xl text-white bg-primary border border-transparent transition-all duration-150 active:scale-95 active:opacity-90 ${
        ...
        <div className="text-center mt-6">
          <p className="text-gray-600">
            ...
            <button
              ...
              className="font-medium text-primary hover:opacity-80 transition-colors cursor-pointer"
            >
              Create Account
            </button>
          </p>
